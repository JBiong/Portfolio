...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
            .send('service_pwkxx1v', 'template_9uzwg8j', {subject: "New Message From Portfolio", name: formData.name, message: formData.message, reply_to: formData.email }, 'CqNC4v1mTaor9u2a')
            .then(
                () => {
